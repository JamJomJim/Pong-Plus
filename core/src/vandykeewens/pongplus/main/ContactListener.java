...
import vandykeewens.pongplus.screens.PlayScreen;
...
public class ContactListener implements com.badlogic.gdx.physics.box2d.ContactListener {
    ...
    public void beginContact(Contact contact) {
        ...
        if (screen.getMode() == Options.Mode.SURVIVAL && (objectA instanceof Ball && objectB == paddleOne || objectA == paddleOne && objectB instanceof Ball)) {
            screen.score("bot");
        }

        if (screen.getMode() == Options.Mode.TARGETS) {
